...
<Link href="/bookipsrdbs/chap19" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
  19. Analysis of Variance
              ...
              <div className="lg:w-3/4">
                ...
                <div className="text-gray-600 mb-6 space-y-6">
                This book has been accessed 70,000 times as of September 10, 2025. <a href="https://link.springer.com/book/10.1007/978-3-031-37865-2?_gl=1*17rnx1i*_up*MQ..&gclid=Cj0KCQjw2a6wBhCVARIsABPeH1vT1jB8a8B-8flWTBxuryQYtkto1SFKqS2SNTzhL8FutIK7z72FYx4aAsTpEALw_wcB" className="text-blue-600 hover:text-blue-800" target="_blank" rel="noopener noreferrer">View the book on Springer</a>.
                </div>
