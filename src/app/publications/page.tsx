...
const PublicationsPage: NextPage<PublicationsPageProps> = () => {
  ...
  <li className="text-gray-800"> Sambasivan, R., Das, S. and Sahu, S. K. (2020) <a href="/publications/Bayesian_Machine_Learning_Review.pdf" className="text-blue-600"> A Bayesian Perspective of Statistical Machine Learning for Big Data. </a>
  ...
  <li className="text-gray-800"> Sahu, S. K., Bakar, K. S., Zhan, J., Campbell, J. L. and Yanai, R. D. (2020) <a href="/publications/Precip_JSM_proceedings_2020.pdf" className="text-blue-600"> Spatio-temporal Bayesian modeling of precipitation using rain gauge data from the Hubbard Brook Experimental Forest, New Hampshire, USA. </a>
    <i> Proceedings of the Joint Statistical Meetings </i> American Statistical Association. Pages: 77-92.
  </li>
  <li className="text-gray-800">Sahu, S. K., Bass, M. R., Sabariego, C., Cieza, A., Fellinghauer, C. S. and Chatterji, S. (2020) <a href="publications/bayesian_gpcm.pdf" className="text-blue-600"> A full Bayesian implementation of a generalised partial credit model with an application to an international disability survey. </a>
    <i> Journal of the Royal Statistical Society, </i> Series C, Applied Statistics, <b> 69, </b> 131-150. https://doi.org/10.1111/rssc.12385 Here are the <a href="publications/sahu_etal_code_and_data.zip" className="text-blue-600"> data and code files. </a> The paper can be accessed from the journal website as well: <a href="https://rss.onlinelibrary.wiley.com/doi/10.1111/rssc.12385" className="text-blue-600"> https://rss.onlinelibrary.wiley.com/doi/10.1111/rssc.12385. </a>
  </li>
  <li className="text-gray-800"> Nicolis, O. Diaz, M., Sahu, S. K. and Marin, J. C. (2019) <a href="publications/nicolis_etal_final.pdf" className="text-blue-600"> Bayesian spatio-temporal modelling for estimating short-term exposure to air pollution in Santiago de Chile. </a>
    <i> Environmetrics, </i>
  ...
  <li className="text-gray-800"> Mukhopadhyay, S. and Sahu, S. K. (2017) <a href="https://doi.org/10.1111/rssa.12299" className="text-blue-600"> A Bayesian spatio-temporal model to estimate long term exposure to outdoor air pollution at coarser administrative geographies in England and Wales. </a>
    ...
    <p> Here is the <a href="publications/webinar_sujit_sahu.pdf" className="text-blue-600"> pdf presentation file. </a> A youtube video <a href="https://www.youtube.com/watch?v=tm_21pqe7YA" className="text-blue-600"> of the webinar </a> is also available. Discussion starts after 20 minutes into the video. </p>
  </li>
  ...
  <li className="text-gray-800"> Lee, D., Mukhopadhyay, S., Rushworth, A. and Sahu, S. K. (2016) <a href="publications/Leebiostats.pdf" className="text-blue-600"> A rigorous statistical framework for estimating the long-term health impact of air pollution. </a> Click <a href="publications/Leebiostatssupp.pdf" className="text-blue-600"> here for supplementary materials.</a>
    <i> Biostatistics, </i> DOI: 10.1093/biostatistics/kxw048.
  </li>
  <li className="text-gray-800"> Utazi, C. E., Sahu, S. K., Atkinson, P. M., Tejedor, N. and Tatem, A. J. (2016) <a href="publications/utazi_etal_2016.pdf" className="text-blue-600"> A probabilistic predictive Bayesian approach for determining the representativeness of health and demographic surveillance networks </a>
    <i> Spatial Statistics </i>
    <b> 16, </b> 161-178.
  </li>
  <li className="text-gray-800"> Pirani, M., Panton, A., Purdie, D. A., Sahu, S. K. (2016) <a href="publications/pirani_et_al2016.pdf" className="text-blue-600"> Modelling macronutrient dynamics in the Hampshire Avon river: A Bayesian approach to estimate effect of storm events </a>
  ...
  <li className="text-gray-800"> Sahu, S. K. and Mukhopadhyay, S. (2016) <a href="publications/sahu_mukhopadhyay_revised.pdf" className="text-blue-600"> On generating a flexible class of anisotropic spatial models using Gaussian predictive processes. </a>
  </li>
  <li className="text-gray-800"> Minty, J., Harper, H., Sarran, C., Sahu, S. K., and Baffour, B. (2013). <a href="publications/eng.pdf" className="text-blue-600"> Simulating Occupancy for Short-Term Hospital Planning. </a>
    <i> Technical Report, </i> University of Southampton.
  </li>
  <li className="text-gray-800"> Lee, D. and Sahu, S. K. (2016) <a href="publications/bookchapter.pdf" className="text-blue-600"> Estimating the health impact of environmental pollution fields. </a> In <i> Handbook of Spatial Epidemiology. </i> Editors: Lawson, A., Banerjee, S., Haining, R. and Ugarte, L. Chapman and Hall/CRC Press. </li>
  <li className="text-gray-800"> Sahu, S. K. (2015) <a href="publications/sujitimpact.pdf" className="text-blue-600"> Bayesian Spatio-Temporal Modelling to Deliver More Accurate and Instantaneous Air Pollution Forecasts. </a> In <i> UK Success Stories in Industrial Mathematics. </i> Editors: P. Aston, T. Mulholland and K. Tant. Springer International. 67-74. </li>
  ...
  <li className="text-gray-800"> Sahu, S. K., Bakar, K. S. and Awang, N. (2015) <a href="publications/sahubakarandwang2013.pdf" className="text-blue-600"> Bayesian Forecasting Using Hierarchical Spatio-temporal Models with Applications to Ozone Levels in the Eastern United States. </a> In <i> Geometry Driven Statistics, </i> Editors: I. L. Dryden and J. Kent. John Wiley and Sons. Chapter 13, pp 260-281. </li>
  <li className="text-gray-800"> Lee, D., Rushworth, A., and Sahu, S. K. (2014) <a href="publications/Lee_preprint.pdf" className="text-blue-600"> A Bayesian localised conditional auto-regressive model for estimating the health effects of air pollution. </a>
    <i> Biometrics, </i>
    <b> 70 </b> , 419-429.
  </li>
  <li className="text-gray-800"> Ewings, S. M., Sahu, S. K., Byrne, C. D., Chipperfield, A. J. (2014) <a href="publications/ewingsetal.pdf" className="text-blue-600"> A Bayesian network for modelling blood glucose concentration and exercise in type 1 diabetes. </a>
    <i> Statistical Methods in Medical Research, </i>
    <b> 24, </b> 342-372, doi: 10.1177/0962280214520732.
  </li>
  <li className="text-gray-800"> Sahu, S. K., Baffour, B., Harper, P. R., Minty, J. H. and Sarran, C. (2014) <a href="publications/admissionmetsim.pdf" className="text-blue-600">A Hierarchical Bayesian Model for Improving Short-Term Forecasting of Hospital Demand by Including Meteorological Information. </a>
    <i> Journal of the Royal Statistical Society, </i> Series A. <b> 177, </b> 39-61.
  </li>
  <li className="text-gray-800"> Ren, C., Sun, D. and Sahu, S. K.(2013) <a href="publications/rensunsahu.pdf" className="text-blue-600"> Objective Bayesian Analysis of Spatial Models with Separable Correlation Functions. </a>
    <i> The Canadaian Journal of Statistics. </i>
    <b> 41, </b> 488-507.
  </li>
  <li className="text-gray-800"> Sahu, S. K. and Bakar, K. S. (2012) <a href="publications/sptimegpp.pdf" className="text-blue-600">Hierarchical Bayesian auto-regressive models for large space time data with applications to ozone concentration modelling. </a>
    <i> Applied Stochastic Models in Business and Industry, </i>
    <b> 28, </b> 395-415.
  </li>
  <li className="text-gray-800"> Gelfand, A. E., Sahu S. K. and Holland, D. M. (2012) <a href="publications/distributedprefsampling.pdf" className="text-blue-600"> On the Effect of Preferential Sampling in Spatial Prediction. </a>
    <i> Environmetrics, </i>
    <b> 23, </b> 565-578.
  </li>
  <li className="text-gray-800"> Sahu, S. K. (2012) <a href="publications/sahu_handbook.pdf" className="text-blue-600"> Hierarchical Bayesian models for space-time air pollution data </a> In <i> Handbook of Statistics-Vol 30. Time Series Analysis, Methods and Applications. </i> Editors: T Subba Rao and C R Rao. Elsevier Publishers, Holland. Elsevier Publishers, Amsterdam, pp 477-495. </li>
  <li className="text-gray-800"> Sahu, S. K. and Bakar, K. S. (2012) <a href="publications/sahubakar11.pdf" className="text-blue-600"> A comparison of Bayesian Models for Daily Ozone Concentration Levels </a>
    <i> Statistical Methodology </i>, <b> 9, </b> 144-157, DOI: 10.1016/j.stamet.2011.04.009.
  </li>
  <li className="text-gray-800"> Sahu, S. K., Yip, S. and Holland, D. M. (2011) <a href="publications/sahuyipholland_env_eco_09.pdf" className="text-blue-600"> A fast Bayesian method for updating and forecasting hourly ozone levels. </a>
    <i> Environmental and Ecological Statistics, </i>
    <b> 18, </b> 185-207, DOI 10.1007/s10651-009-0127-y.
  </li>
  <li className="text-gray-800"> Sahu, S. K., Gelfand, A. E. and Holland, D. M. (2010) <a href="publications/sahuetal2010.pdf" className="text-blue-600"> Fusing point and areal level space-time data with application to wet deposition. </a>
    <i> Journal of the Royal Statistical Society</i>, Series C, Applied Statistics, <b> 59 </b>, 77-103.
  </li>
  <li className="text-gray-800"> Gelfand, A. E. and Sahu, S. K. (2009) <a href="publications/gelfandsahu09.pdf" className="text-blue-600"> Combining Monitoring Data and Computer model Output in Assessing Environmental Exposure. </a> In <i> Handbook of Applied Bayesian Analysis </i> edited by Anthony OHagan and Mike West, pp482-510. </li>
  <li className="text-gray-800"> Sahu, S. K. and Chai, H. S. (2009) <a href="/publications/chai" className="text-blue-600"> A new skew-elliptical distribution and its properties. </a>
    <i> Calcutta Statistical Association Bulletin, </i>
    <b> 61, </b> 197--225.
  </li>
  <li className="text-gray-800"> Sahu, S. K., Yip, S. and Holland, D. M. (2009) <a href="publications/sahuyipholland.pdf" className="text-blue-600"> Improved space-time forecasting of next day ozone concentrations in the eastern U.S </a>
  ...
  <li className="text-gray-800"> Jona Lasinio, G., Sahu, S. K. and Mardia, K. V. (2007) <a href="/publications/varanasi" className="text-blue-600"> Modeling rainfall data using a Bayesian Kriged-Kalman model. </a> In <i> Bayesian Statistics and its Applocations</i> edited by S. K. Upadhya, U. Singh and D. K. Dey. Anshan Ltd. London. </li>
  ...
  <li className="text-gray-800"> Buck, C. E. and Sahu, S. K. (2000) <a href="/publications/arch" className="text-blue-600"> Bayesian models for relative archaeological chronology building. </a>
    <i> Applied Statistics. </i>
    <b> 49, </b> 423--440
  </li>
  <li className="text-gray-800"> Sahu, S. K. and Dey, D. K. (2000) <a href="/publications/comp" className="text-blue-600"> A Comparison of Frailty and Other Models for Bivariate Survival Data. </a>
    <i> Lifetime Data Analysis. </i>
    <b> 6 </b> 207--228.
  </li>
  <li className="text-gray-800"> Sahu, S. K. and Roberts, G. O. (1999) <a href="/publications/em" className="text-blue-600"> On Convergence of the EM Algorithm and the Gibbs Sampler. </a>
    <i>Statistics and Computing. </i>
    <b>9, </b>55--64.
  </li>
  <li className="text-gray-800"> Mukhopadhyay, N., Chattopadhyay, S. and Sahu, S. K. (1993) <a href="https://link.springer.com/article/10.1007/BF02613675" className="text-blue-600"> Further Developments in Estimation of the Largest Mean of <i> K </i> Normal Populations. </a>
    <a>
      ...
      <b> 40, </b> 173--183. </a>
            ...
            <li className="text-gray-800">
              Gilks, W. R., Roberts, G. O. and Sahu, S. K. (1998) <a href="publications/gilksetal98.pdf" className="text-blue-600">Adaptive Markov Chain Monte Carlo through Regeneration.</a> <i>Journal of the American Statistical Association,</i> <b>93,</b> 1045--1054.
            </li>
            <li className="text-gray-800">
